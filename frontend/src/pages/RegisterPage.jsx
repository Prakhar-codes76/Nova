...
export const RegisterPage = () => {
  ...
  return (
    <div className="login-page-container">
      ...
      {/* Dark Purple/Blue Ambient Overlay & VFX Particles */}
      ...
      <div className="login-glass-card page-fade-in">
        <div className="login-logo-container" style={{ marginBottom: '1.25rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
            Create your account to start smart learning
          </p>
        </div>
